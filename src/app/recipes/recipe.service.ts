...
export class RecipeService {
  ...
  storeData() {
    ...
    return this.http.put('https://recipebook-f948a.firebaseio.com/recipes.json', body, { headers: headers })
  }

  fetchData() {
    return this.http.get('https://recipebook-f948a.firebaseio.com/recipes.json')
